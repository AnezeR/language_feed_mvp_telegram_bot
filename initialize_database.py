...
def initialize_database():
    ...
    preload_prerequisites = [
        (content_id, database.content_get_content(content_id), database.content_get_val_type(content_id)) for content_id
        in database.content_get_ids_to_preload()]
...
def check_if_database_exists():
    # If the database does not exist, initializes it
    if not os.path.exists(os.path.dirname(__file__) + '/database/database_volume/database.sqlite'):
        initialize_database()
